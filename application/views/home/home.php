		<img id="home" class="show-for-medium-up head_img" src="<?php print base_url(); ?>/static/img/headimg.jpg"/>
		<div data-stellar-ratio="1.35" class="show-for-medium-up header_text">
			<h1 class="show-for-medium-up">Neises Home Designs.</h1>
			<h2 class="show-for-medium-up">Improving your home, one room at a time.</h2>
		</div>
		<section id="about" class="section_odd main-section main_top">
		...
		<section id="better" class="section_even main-section">
			<section class="full-width content-section">
				<div class="row">
					<div class="small-12 medium-12 large-12 columns">
		...
		<section id="simpler" class="section_odd main-section">
			<section class="full-width content-section">
				<div class="row">
					<div class="small-12 medium-12 large-12 columns">
